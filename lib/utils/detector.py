...
class Detector(object):
    def __init__(self, net, imdb, weights_file
        ...
        self._image_size = common_conf['image_size']
        self._cell_size = common_conf['cell_size']
        self._boxes_per_cell = net_conf['boxes_per_cell']
    ...
    def iou(self, box1, box2):
        x1_1 = box1[0] - box1[2] * 0.5
        x2_1 = box1[0] + box1[2] * 0.5
        y1_1 = box1[1] - box1[3] * 0.5
        y2_1 = box1[1] + box1[3] * 0.5

        x1_2 = box2[0] - box2[2] * 0.5
        x2_2 = box2[0] + box2[2] * 0.5
        y1_2 = box2[1] - box2[3] * 0.5
        y2_2 = box2[1] + box2[3] * 0.5
    ...
    def detect(self, img):
        ...
        res = self.detect_from_cvmat(inp)
        return res
